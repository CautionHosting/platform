        ...
        Self {
            ...
            rates: vec![
                ...
                PricingRate {
                    provider: Provider::Aws,
                    resource_type: ResourceType::Compute,
                    instance_type: Some("r6i.xlarge".to_string()),
                    region: None,
                    rate_per_unit: 0.252,
                },
                PricingRate {
                    provider: Provider::Aws,
                    resource_type: ResourceType::Compute,
                    instance_type: Some("r6i.2xlarge".to_string()),
                    region: None,
                    rate_per_unit: 0.504,
                },
                PricingRate {
                    provider: Provider::Aws,
                    resource_type: ResourceType::Compute,
                    instance_type: Some("r6i.4xlarge".to_string()),
                    region: None,
                    rate_per_unit: 1.008,
                },
                PricingRate {
                    provider: Provider::Aws,
                    resource_type: ResourceType::Compute,
                    instance_type: Some("r6i.8xlarge".to_string()),
                    region: None,
                    rate_per_unit: 2.016,
                },
                PricingRate {
                    provider: Provider::Aws,
                    resource_type: ResourceType::Compute,
                    instance_type: Some("r6i.12xlarge".to_string()),
                    region: None,
                    rate_per_unit: 3.024,
                },
                PricingRate {
