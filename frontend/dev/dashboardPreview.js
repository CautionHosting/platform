...
const previewBillingUsage = {
  total_cost: 332.35,
  lifetime_cost: 1847.63,
  projected_cost: 441.36,
  billing_period_start: '2026-08-01',
  billing_period_end: '2026-09-01',
  items: [
    {
      id: 'usage:app_preview_1:app_preview_1:payments-enclave:compute:hours:us-west-2:1.1200000000',
      application_id: 'app_preview_1',
      resource_id: 'app_preview_1',
      resource_name: 'payments-enclave',
      resource_type: 'compute',
      region: 'us-west-2',
      last_recorded_at: '2026-08-21T12:00:00Z',
      quantity: 128,
      unit: 'hours',
      rate: 1.12,
      cost: 143.36,
    ...
    {
      id: 'usage:app_preview_2:app_preview_2:hello-world:compute:hours:us-east-1:0.3700000000',
      application_id: 'app_preview_2',
      resource_id: 'app_preview_2',
      resource_name: 'hello-world',
      resource_type: 'compute',
      region: 'us-east-1',
      last_recorded_at: '2026-08-14T09:30:00Z',
      quantity: 48,
      unit: 'hours',
      rate: 0.37,
      cost: 17.76,
      projected_cost: 17.76,
    },
  ],
  subscription_items: [
    {
      ...
      tier: 'Managed 4',
      resource_name: 'BYOC subscription',
...
const previewSubscription = {
  subscription: {
    ...
    hourly_rate_usd: 0.3424657534,
    enclaves: 4,
    enclave_limit: 4,
    allocated_enclaves: 3,
...
export const resolveDashboardPreviewRequest = (input, rawUrl) => {
  ...
  if (path === '/api/quorum-bundles/participants') return jsonResponse(200, [
    { user_id: '11111111-1111-4111-8111-111111111111', username: 'preview-operator', pgp_keys: [{ id: 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', fingerprint: previewPgpKeys.keys[0].fingerprint, public_key: '' }], webauthn_credentials: 2, webauthn_uv_credentials: 1 },
    { user_id: '22222222-2222-4222-8222-222222222222', username: 'preview-dev', pgp_keys: [], webauthn_credentials: 1, webauthn_uv_credentials: 1 },
    { user_id: '33333333-3333-4333-8333-333333333333', username: 'preview-ineligible', pgp_keys: [], webauthn_credentials: 0, webauthn_uv_credentials: 0 },
  ])
